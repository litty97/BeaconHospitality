<?php
	if (!class_exists('TS_Image_Galleries')){
		class TS_Image_Galleries {
			...
			function TS_VCSC_LightboxGridImageDataArray($i, $p, $t, $a, $g) {
				return array('image' => (!empty($i) ? $i : ""), 'preview' => (!empty($p) ? $p : (!empty($i) ? $i : "")), 'title' => (!empty($t) ? $t : ""), 'alt' => (!empty($a) ? $a : ""), 'groups' => (!empty($g) ? $g : ""), 'lightbox' => (!empty($t) ? $t : ""));
			}
			...
			function TS_VCSC_Lightbox_Gallery_Standalone ($atts, $content = null) {
				...
				extract( shortcode_atts( array(
					...
					'lightbox_speed'			=> 5000,
					'lightbox_social'			=> $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_SocialNetworkAPIs,
				...
				$content_combined 				= array_map(array($this, 'TS_VCSC_LightboxGridImageDataArray'), $content_images, $content_previews, $content_images_titles, $content_images_alts, $content_images_groups);
				...
				if ($content_linkstyle != "none") {
					if ($content_linkstyle == "lightbox") {
						if (strtolower($content_style) == "honeycombs") {
							...
							$image_link_class	= "nch-lightbox-slickslider no-ajaxy";
						} else {
					...
					if (strtolower($content_style) == "grid") {
						...
						$modal_gallery .= '<div id="' . $modal_id . '-grid" class="ts-lightbox-gallery-grid">';
							foreach($content_combined as $image => $meta) {
								...
								// Check ALT Tag
								if ($meta['alt'] == "") {
									$modal_path				= TS_VCSC_GetPathInfo($preview_thumb);
									$meta['alt'] 			= (isset($modal_path['filename']) ? $modal_path['filename'] : "");
								}
								if ($i == $nachoLength) {
									...
									$modal_gallery .= '<a style="' . $grid_style . '" id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-random="' . $randomizer . '" data-include="true" data-hover="' . (!empty($meta['title']) ? $meta['title'] : "") . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '" class="nch-lightbox-media no-ajaxy ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . ' data-captions="true" data-grid="' . $data_grid_breaks . '" data-gridspace="' . $data_grid_space . '" data-gridorder="' . $data_grid_order . '" data-gridfilter="true" data-gridavailable="' . $filters_available . '" data-gridselected="' . $filters_selected . '" data-gridnogroups="' . $filters_nogroups . '" data-gridtoggle="' . $filters_toggle . '" data-gridtogglestyle="' . $filters_toggle_style . '" data-gridshowall="' . $filters_showall . '" data-gridshowallstyle="' . $filters_showall_style . '">';
										$modal_gallery .= '<img src="' . $preview_thumb . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" class="nch-lb-makegrid" data-no-lazy="1">';
									$modal_gallery .= '</a>';
								} else {
									$modal_gallery .= '<a style="' . $grid_style . '" id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-include="true" data-hover="' . (!empty($meta['title']) ? $meta['title'] : "") . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '" class="nch-lightbox-media no-ajaxy ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" ' . $nacho_color . ' data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '">';
										$modal_gallery .= '<img src="' . $preview_thumb . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" class="nch-lb-makegrid" data-no-lazy="1">';
									$modal_gallery .= '</a>';
								}
							}					
							...
							foreach($content_combined as $image => $meta) {
								...
								if ($i == $nachoLength) {
									...
									$modal_gallery .= '<div id="' . $nacho_group . '-' . $i .'-parent" class="ts-lightbox-freewall-item ts-lightbox-freewall-active ' . $nacho_group . '-parent ' . $el_class . ' nchgrid-item nchgrid-tile nch-lightbox-image" data-fixSize="false" style="width: ' . $freewall_width . 'px; margin: 0; padding: 0;" data-showing="true" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '">';
										$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" class="' . $image_link_class . ' ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
											$modal_gallery .= '<img src="' . $preview_thumb . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-no-lazy="1" class="nch-lb-makegrid">';
						...
						foreach($content_combined as $image => $meta) {
							...
							if (($i == $modal_pick) || ($nachoLength == 0)) {
								$modal_gallery .= '<div class="nchgrid-item nchgrid-tile nch-lightbox-trigger ' . ($trigger_grayscale == "true" ? "nch-lightbox-trigger-grayscale" : "") . '" style="">';
									$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" class="nch-lightbox-media no-ajaxy ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" ' . $nacho_color . ' data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '">';
								...
								$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" style="display: none;" href="' . $modal_image . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" class="nch-lightbox-media no-ajaxy ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
								...
								foreach ($content_combined as $image => $meta) {
									...
									if ($i == $nachoLength) {
										...
										$modal_gallery .= '<div id="' . $nacho_group . '-' . $i .'-parent" class="ts-slickslider-section" style="margin: 0 ' . ($slickmain_spacing / 2) . 'px;" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '">';											
											if ($content_linkstyle != "none") {
												$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" data-thumb="' . $modal_thumb . '" class="' . $image_link_class . ' ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
											}
										...
										$modal_gallery .= '<div id="' . $nacho_group . '-section-' . $i .'-parent" class="ts-slickslider-section" style="margin: 0 ' . ($slickmain_spacing / 2) . 'px;" data-groups="' . (!empty($meta['groups']) ? (str_replace('/', ',', $meta['groups'])) : "") . '">';											
											if ($content_linkstyle != "none") {
												$modal_gallery .= '<a id="' . $nacho_group . '-link-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" data-thumb="' . $modal_thumb . '" class="' . $image_link_class . ' ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" ' . $nacho_color . ' data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '">';
											}
												$modal_gallery .= '<img class="ts-slickslider-gallery-image" src="' . ($slickmain_lazyload == "true" ? "" : $preview_thumb) . '" data-lazy="' . ($slickmain_lazyload == "false" ? "" : $preview_thumb) . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-no-lazy="1" data-title="' . (!empty($meta['title']) ? $meta['title'] : "") . '" style="">';
												$modal_gallery .= '<div class="ts-slickslider-gallery-' . ($content_linkstyle != "none" ? "overlay" : "noeffect") . '"></div>';
												if (!empty($meta['title'])) {
										...
										if ($i == $nachoLength) {
											...
											$modal_gallery .= '<li data-counter="' . ($i + 1) . '" style="' . ((strtolower($content_style) == "flexthumb") ? "margin: 0;" : "margin: 0px " . ((($number_images == 1) || ($page_rtl == "true")) ? 0 : $flex_margin) . "px 0px " . ((($number_images == 1) || ($page_rtl == "false")) ? 0 : $flex_margin) . "px;") . '"><div id="' . $nacho_group . '-' . $i .'-parent" class="' . $nacho_group . '-parent ' . $el_class . ' nchgrid-item nchgrid-tile nch-lightbox-image" style="">';
												if ($content_linkstyle != "none") {
													...
													$modal_gallery .= '<img src="' . $modal_thumb . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-no-lazy="1" style="">';
													$modal_gallery .= '<div class="nchgrid-caption ' . $image_title_class . '"></div>';
													if (!empty($meta['title'])) {
														$modal_gallery .= '<div class="nchgrid-caption-text">' . $meta['title'] . '</div>';
													}
							...
							$modal_gallery .= '<ul id="ts-pagawa-slideshow-wrapper-' . $randomizer . '" class="ts-pagawa-slideshow-wrapper" style="display: none;">';				
								foreach($content_combined as $image => $meta) {
									...
									if ($content_external == "true") {
										...
										// Force Equal Slider Thumbnail Size
										if ($thumbnail_size != "thumbnail") {
											$slide_image		= preg_replace('/[^\d]/', '', $meta['preview']);
											$slide_image		= wp_get_attachment_image_src($slide_image, "thumbnail");
											$slide_image		= $slide_image[0];
										} else {
											$slide_image		= $modal_thumb;
										}
									}
									// Check ALT Tag
									if ($meta['alt'] == "") {
									...
									if ($i == $nachoLength) {
										...
										$modal_gallery .= '<li>';
											if ($content_linkstyle != "none") {
												...
												$modal_gallery .= '<img src="' . $slide_image . '" data-large-src="' . $thumb_image . '" alt="' . (!empty($meta['alt']) ? $meta['alt'] : (!empty($meta['title']) ? $meta['title'] : "")) . '" data-description="">';
											if ($content_linkstyle != "none") {
												$modal_gallery .= '</a>';
											}
										$modal_gallery .= '</li>';
								...
								foreach($content_combined as $image => $meta) {
									...
									if ($content_external == "true") {
										...
										if (($lightbox_size == $content_images_size) && ($meta['image'] == $meta['preview'])) {
											...
											$preview_height		= ($modal_image[2] == 0 ? 1 : $modal_image[2]);
											$preview_ratio		= ($preview_width / $preview_height);
										} else {
											$preview_thumb		= wp_get_attachment_image_src($meta['preview'], $content_images_size);										
											$preview_width		= $preview_thumb[1];
											$preview_height		= ($preview_thumb[2] == 0 ? 1 : $preview_thumb[2]);
											$preview_ratio		= ($preview_width / $preview_height);
											$preview_thumb		= $preview_thumb[0];
										}
										$modal_image			= $modal_image[0];
								...
								if ($i == $nachoLength) {
									...
									$modal_gallery .= '<li>';
										$modal_gallery .= '<div class="st-item">';
											$modal_gallery .= '<div id="' . $nacho_group . '-' . $i .'-parent" class="' . $nacho_group . '-parent ' . $el_class . ' nchgrid-item nchgrid-tile nch-lightbox-image" style="">';
												if ($content_linkstyle != "none") {
													$modal_gallery .= '<a id="' . $nacho_group . '-' . $i .'" href="' . $modal_image . '" target="_blank" data-thumbnail="' . $modal_thumb . '" data-title="' . (!empty($meta['lightbox']) ? $meta['lightbox'] : "") . '" class="' . ($content_linkstyle == "lightbox" ? "nch-lightbox-stack" : "nch-lightbox-disabled") . ' ts-hover-image ' . $nacho_group . ' nofancybox" rel="' . $nacho_group . '" data-effect="' . $lightbox_effect . '" data-usecors="' . $lightbox_usecors . '" data-share="' . ($lightbox_social == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-play="' . ($lightbox_autooption == "true" ? 1 : 0) . '" data-autoplay="' . ($lightbox_autoplay == "true" ? 1 : 0) . '" data-duration="' . $lightbox_speed . '" data-thumbsize="' . $thumbnail_height . '" data-thumbs="' . $thumbnail_position . '" ' . $nacho_info . ' ' . $nacho_color . '>';
												}
													$modal_gallery .= '<img src="' . $preview_thumb . '" style="" alt="' . (!empty($meta['alt']) ? $meta['alt'] : "") . '" data-no-lazy="1" data-width="' . $preview_width . '" data-height="' . $preview_height . '" data-ratio="' . $preview_ratio . '" data-stack="">';
													$modal_gallery .= '<div class="nchgrid-caption ' . $image_title_class . '"></div>';
													if (!empty($meta['title'])) {
				...
				$VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
					...
					"params"                        => array(
						...
						array(
							...
							"dependency"            => array( 'element' => "content_style", 'value' => array('Slider', 'FlexThumb', 'FlexSingle', 'NivoSlider', 'SliceBox', 'SlickSingle', 'SlickThumb', 'Stack', 'Polaroid') ),
							"group" 				=> "Layout"
						),
						array(
							"type"				    => "livepreview",
							...
							"dependency"            => array( 'element' => "content_style", 'value' => array('Polaroid') ),
							"group"					=> "Layout",
						),						
						array(
							"type"              	=> "switch_button",
						...
						array(
							...
							"value"				    => $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_SocialNetworkAPIs,
