		...
		class TS_Fancy_Tabs {
			...
			function TS_VCSC_FancyTabs_Container ($atts, $content = null) {
				...
				if ($icontabs_frontend == "false") {				
					...
					if ($styles != "") {
						wp_add_inline_style('ts-extend-fancytabs', TS_VCSC_MinifyCSS($styles));
					}
					
					// Create Main Tabs Navigation
					$navigation 					= '';
					$navigation .= '<ul class="pws_tabs_controlls ts-fancy-tabs-hidden" style="display: none;">';
						$tab_count					= 0;
					...
					$output .= '<div id="ts-fancy-tabs-main-wrapper-' . $tab_contid . '" class="ts-fancy-tabs-main-wrapper ' . $el_class . ' ' . $css_class . '" ' . $tabs_data . ' ' . $tabs_tooltip . ' ' . $tabs_rotate . ' ' . $tabs_styling . ' style="' . ($icontabs_frontend == "true" ? "margin-top: 40px; margin-bottom: 40px;" : "") . '">';
						$output .= '<div class="ts-fancy-tabs-container pws_tabs_container pws_tabs_responsive_large ' . $class_align . ' ' . $class_rtl . ' ' . $class_effect . ' ' . $class_theme . ' ' . $class_rotate . '" data-align="' . $tabs_align . '" data-position="' . ($tabs_align == "vertical" ? $tabs_vertical : $tabs_horizontal) . '" style="width: ' . $tabs_fullwidth . '%;">';
							...
							$output .= $hamburger;
							// Main Tabs Content
							$output .= '<div class="ts-fancy-tabs-content ts-fancy-tabs-loader pws_tabs_list">';
