				...
				foreach ($social_array as $index => $array) {
					...
					$social_networks .= '<li style="display: inline-block; width: 100%; margin: 5px 0px;" data-order="' . $Social_Order . '" data-network="' . $Social_Network . '" data-original="' . $Social_Original . '">';
						...
						if (($Social_Network == "Email") || ($Social_Network == "Paypal")) {
							$social_networks .= '<input class="validate[custom[email]]" data-error="Social Network Links - ' . ucwords($Social_Network) . '" data-order="11" type="text" style="width: 20%;" id="ts_vcsc_social_link_' . $Social_Network . '" name="ts_vcsc_social_link_' . $Social_Network . '" value="'.  $Social_Link . '" size="100">';
						} else if (($Social_Network == "Phone") || ($Social_Network == "Cell")) {
							$social_networks .= '<input class="validate[custom[phone]]" data-error="Social Network Links - ' . ucwords($Social_Network) . '" data-order="11" type="text" style="width: 20%;" id="ts_vcsc_social_link_' . $Social_Network . '" name="ts_vcsc_social_link_' . $Social_Network . '" value="'.  $Social_Link . '" size="100">';
						} else if ($Social_Network == "Skype") {
							$social_networks .= '<input class="validate[custom[onlyClassNames]]" data-error="Social Network Links - ' . ucwords($Social_Network) . '" data-order="11" type="text" style="width: 20%;" id="ts_vcsc_social_link_' . $Social_Network . '" name="ts_vcsc_social_link_' . $Social_Network . '" value="'.  $Social_Link . '" size="100">';
						} else {
							$social_networks .= '<input class="validate[custom[url]]" data-error="Social Network Links - ' . ucwords($Social_Network) . '" data-order="11" type="text" style="width: 20%;" id="ts_vcsc_social_link_' . $Social_Network . '" name="ts_vcsc_social_link_' . $Social_Network . '" value="'.  $Social_Link . '" size="100">';
						}
