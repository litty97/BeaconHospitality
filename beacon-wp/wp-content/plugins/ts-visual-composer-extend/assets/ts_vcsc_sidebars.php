...
<?php
	echo '<div class="ts-vcsc-settings-group-header">';
		echo '<div class="display_header">';
			echo '<h2><span class="dashicons dashicons-welcome-widgets-menus"></span>Visual Composer Extensions - Sidebars Manager</h2>';
		echo '</div>';
...
<form id="ts-vcsc-extend-sidebars" class="ts-vcsc-sidebars-check-wrap" name="oscimp_form" data-type="sidebars" autocomplete="off" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	...
	<span class="submit">		
		<?php		
			echo '<input id="ts-vcsc-extend-sidebars-submit" title="Save Sidebars Manager settings." style="width: 200px; margin-top: 20px;" class="ts-vcsc-extend-sidebars-submit button-primary ButtonSubmit TS_Tooltip" type="submit" name="Sidebars" value="Save Settings" />';
		?>
	</span>
</form>