<?php
    ...
    // Visual Composer Styling + Elements
    ...
    wp_register_script('ts-visual-composer-extend-composer',					$url . 'js/ts-visual-composer-extend-composer.min.js', array('jquery'), COMPOSIUM_VERSION, $FOOTER);
    ...
    if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_UseInternalLightbox == "true") {
        wp_register_style('ts-extend-nacho',									$url . 'css/jquery.vcsc.nchlightbox.min.css', null, COMPOSIUM_VERSION, 'all');
        wp_register_script('ts-extend-nacho', 									$url . 'js/jquery.vcsc.nchlightbox.min.js', array('jquery'), COMPOSIUM_VERSION, $FOOTER);
    }
    ...
    if (isset($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_InformationExternalAPIs['GoogleMaps'])) {
        ...
        wp_register_script('ts-extend-mapapi-library',							'https://maps.google.com/maps/api/js?key=' . $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_InformationExternalAPIs['GoogleMaps'] . '&libraries=places', false, false, false);
    } else {
        wp_register_script('ts-extend-mapapi-none',								'https://maps.google.com/maps/api/js', false, false, false);
        wp_register_script('ts-extend-mapapi-library',							'https://maps.google.com/maps/api/js?libraries=places', false, false, false);
    }
