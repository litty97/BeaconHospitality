	...
	if (!function_exists('TS_VCSC_ShowInformation')){
		function TS_VCSC_ShowInformation($item_id, $item_vc = true) {
			...
			if (($api_data == "") || (($api_last + 3600) < $api_current)) {				
				/* Fetch Data using the cURL Request */
			...
			if ($item === false) {
				$ts_vcsc_extend_envatoItem_HTML 	= '<p style="text-align: justify;">Oops... Something went wrong. Could not retrieve item information from Envato.</p>';
							...
							<div class="ts_vcsc_middle">
								<div class="ts_vcsc_sales">
									...
									<div class="ts_vcsc_text">
										<span class="ts_vcsc_num">' . number_format(floatval($ts_vcsc_extend_envatoItem_Sales), 0) . '</span>
