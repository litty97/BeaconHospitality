<?php
	...
	$ts_vcsc_extend_settings_defaultLightboxAnimation 			= ((array_key_exists('animation', $TS_VCSC_Lightbox_Defaults)) 		? $TS_VCSC_Lightbox_Defaults['animation'] 				: $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Lightbox_Setting_Defaults['animation']);
	$TS_VCSC_Export_Options['ts_vcsc_extend_settings_defaultLightboxAnimation'] = ($ts_vcsc_extend_settings_defaultLightboxAnimation);
