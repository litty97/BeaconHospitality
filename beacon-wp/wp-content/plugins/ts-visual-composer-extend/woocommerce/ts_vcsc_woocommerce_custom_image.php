...
if (!class_exists('TS_WooCommerce_ImageGrid_Basic')){
	class TS_WooCommerce_ImageGrid_Basic {
		function __construct() {
            ...
            if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode == "true") {
				if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_LeanMap == "true") {
					$this->TS_VCSC_WooCommerce_ImageGrid_Basic_Lean();
				} else if (function_exists('vc_map')) {
					add_action('init',                                  array($this, 'TS_VCSC_WooCommerce_ImageGrid_Basic_Elements'), 9999999);
				}
            } else {
				if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_LeanMap == "true") {
					add_action('admin_init',							array($this, 'TS_VCSC_WooCommerce_ImageGrid_Basic_Lean'), 9999999);
				} else if (function_exists('vc_map')) {
		...
		function TS_VCSC_WooCommerce_ImageGrid_Basic_Lean() {
			vc_lean_map('TS_VCSC_WooCommerce_ImageGrid_Basic', 			array($this, 'TS_VCSC_WooCommerce_ImageGrid_Basic_Elements'), null);
		}
