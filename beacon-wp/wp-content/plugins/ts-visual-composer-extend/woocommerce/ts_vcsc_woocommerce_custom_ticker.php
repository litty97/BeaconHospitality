...
if (!class_exists('TS_WooCommerce_Ticker_Basic')){
	class TS_WooCommerce_Ticker_Basic {
		function __construct() {
            ...
            if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VCFrontEditMode == "true") {
				if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_LeanMap == "true") {
					$this->TS_VCSC_WooCommerce_Ticker_Basic_Lean();
				} else if (function_exists('vc_map')) {
					add_action('init',                                  array($this, 'TS_VCSC_WooCommerce_Ticker_Basic_Elements'), 9999999);
				}
            } else {
				if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_LeanMap == "true") {
					add_action('admin_init',							array($this, 'TS_VCSC_WooCommerce_Ticker_Basic_Lean'), 9999999);
				} else if (function_exists('vc_map')) {
		...
		function TS_VCSC_WooCommerce_Ticker_Basic_Lean() {
			vc_lean_map('TS_VCSC_WooCommerce_Ticker_Basic', 			array($this, 'TS_VCSC_WooCommerce_Ticker_Basic_Elements'), null);
		}
        
        // Basic Products Ticker
        ...
        // Add WooCommerce Basic Ticker Elements
        function TS_VCSC_WooCommerce_Ticker_Basic_Elements() {
            global $VISUAL_COMPOSER_EXTENSIONS;
            // Add Basic Products Ticker
            $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
				...
				"params"                            => array(
					...
					array(
						"type"                      => "textfield",
						"heading"                   => __( "Add To Cart Text", "ts_visual_composer_extend" ),
						"param_name"                => "ticker_add_item",
						"value"                     => "Add This Item",
						"description"               => __( "Enter the title text to be used for the add to cart link.", "ts_visual_composer_extend" ),
						"dependency"        		=> array("element" 	=> "ticker_cart", "value" 	=> "true"),
						"group" 			        => "",
					),
					array(
						"type"                      => "textfield",
						"heading"                   => __( "Remove From Cart Text", "ts_visual_composer_extend" ),
						"param_name"                => "ticker_remove_item",
						"value"                     => "Remove This Item",
						"description"               => __( "Enter the title text to be used for the remove from cart link.", "ts_visual_composer_extend" ),
						"dependency"        		=> array("element" 	=> "ticker_cart", "value" 	=> "true"),
						"group" 			        => "",
					),
					array(
...
// Initialize "WooCommerce Basic Ticker" Class
if (class_exists('TS_WooCommerce_Ticker_Basic')) {
