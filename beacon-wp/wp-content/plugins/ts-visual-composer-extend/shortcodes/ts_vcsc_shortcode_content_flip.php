<?php
	...
	function TS_VCSC_Content_Flip_Function ($atts) {
		...
		if ($flip_style == "style1") {
			$output .= '<div id="' . $flip_box_id . '" class="flip-container-frame ' . $flipper_type . ' ' . $el_class . ' ' . $animation_css . ' ' . ($flip_size_auto == "true" ? "auto" : "fixed") . ' ' . $css_class . '" data-trigger="' . $flip_trigger . '" data-autoheight="' . $flip_size_auto . '" data-fixedtype="' . $flip_size_type . '" data-fixedheight="' . $flip_size . '" style="' . $content_height . ' width: 100%; margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px;">';
				if ($flip_handle_show == "true") {
					...
					$output .= '<div class="flip-container-main ' . $flip_effect_style1 . ' ' . $flip_effect_speed . '" data-speed="' . $effectspeed . '" style="' . $content_height . '">';
						$output .= '<div class="flip-container-flipper" style="' . $content_height . '">';
							$output .= '<div class="flip-container-flipper-content flip-container-flipper-front ' . $flip_effect_speed . '" style="' . ($flip_size_auto == "true" ? "" : "height: 100%; ") . $content_height . ' width: 100%; background-color: ' . $front_background . '; ' . $flip_border_style_front . '">';
								$output .= '<div class="ts-flip-content" style="color: ' . $front_color . '; ' . $front_panel_adjust . '">';
									if ($front_image_full == "true") {
										...
										if (($front_icon_replace == "false") && ($front_icon != '')) {
										...
										} else if (($front_icon_replace == "true") && ($front_image_path[0] != '')) {
										...
										$output .= '<' . $front_wrapper . ' class="ts-flip-front-title" style="color: ' . $front_color_title . '; ' . $google_font_fronttitle . '">' . $front_title . '</' . $front_wrapper . '>';
										if ($front_html == "true") {
								...
								$output .= '</div>';
							$output .= '</div>';
							$output .= '<div class="flip-container-flipper-content flip-container-flipper-back ' . $flip_effect_speed . '" style="' . ($flip_size_auto == "true" ? "" : "height: 100%; ") . $content_height . ' width: 100%; background-color: ' . $back_background . '; ' . $flip_border_style_back . '">';
								$output .= '<div class="ts-flip-content" style="color: ' . $back_color . ';">';
									$output .= '<' . $back_wrapper . ' class="ts-flip-back-title" style="color: ' . $back_color_title . '; ' . $google_font_backtitle . '">' . $back_title . '</' . $back_wrapper . '>';
									if ($back_html == "true") {
			...
			$output .= '<div class="clearfix">';
				$output .= '<div id="' . $flip_box_id . '" class="ts-flip-cube ' . $flip_effect_style2 . ' ' . $flipper_type . ' ' . $el_class . ' ' . $animation_css . ' ' . ($flip_size_auto == "true" ? "auto" : "fixed") . '  ' . $css_class . '" data-trigger="' . $flip_trigger . '" data-autoheight="' . $flip_size_auto . '" data-fixedtype="' . $flip_size_type . '" data-fixedheight="' . $flip_size . '" style="' . $content_height . 'width: 100%; margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px;">';
					if ($flip_handle_show == "true") {
						$output .= '<div class="ts-flip-padding" style="' . $flip_handle_padding . ' ' . $content_height . '">';
					}
							...
							$output .= '<div class="ts-front" style="height: 100%; width: 100%; background-color: ' . $front_background . '; ' . $flip_border_style_front . '">';
								$output .= '<div class="ts-flip-content" style="color: ' . $front_color . '; ' . $front_panel_adjust . '">';
									if ($front_image_full == "true") {
										...
										$output .= '<' . $front_wrapper . ' class="ts-flip-front-title" style="color: ' . $front_color_title . '; ' . $front_panel_adjust . '; ' . $google_font_fronttitle . '">' . $front_title . '</' . $front_wrapper . '>';
										if ($front_html == "true") {
											$output .= '<p class="ts-flip-front-content ts-flip-text" style="' . $google_font_frontcontent . '">' . do_shortcode(rawurldecode(base64_decode(strip_tags($front_content_html)))) . '</p>';
										} else {
											$output .= '<p class="ts-flip-front-content ts-flip-text" style="' . $google_font_frontcontent . '">' . strip_tags($front_content) . '</p>';
