<?php
	...
	function TS_VCSC_Timeline_Function ($atts) {
		...
		if (($timeline_style == 'style1') || ($timeline_style == 'style3')) {
			$icon_style					= 'height: ' . $icon_size_adjust . 'px; width: ' . $icon_size_adjust . 'px; font-size: ' . round($icon_size_adjust * $icon_ratio / 100) . 'px; line-height: ' . $icon_size_adjust . 'px; padding: ' . $icon_padding . 'px; color: ' . $icon_color . '; background-color:' . $icon_background . ';';
		} else {
			$icon_style					= 'color: ' . $icon_color . '; background-color:' . $icon_background . ';';
		}
		
		if (($timeline_style == 'style1') || ($timeline_style == 'style3')) {
			$image_style				= 'height: ' . $icon_size . 'px; width: ' . $icon_size . 'px; font-size: ' . round($icon_size_adjust * $icon_ratio / 100) . 'px; line-height: ' . $icon_size . 'px; padding: ' . $icon_padding . 'px; background-color:' . $icon_background . ';';
		} else {
