<?php
	...
	function TS_VCSC_Icon_Title_Function ($atts) {
		...
		// Check for Automated Page/Post Title
		if ($title_auto == "true") {
			$use_encode						= "false";
			$title_encoded					= "";
			$title							= get_the_title();
		...
		if (($style == "false") || ($title_background_type == "pattern")) {
			$style							= 'simple';
		} else if ($style == "true") {
			$style							= 'pattern-dark';
		} else if ($style == "light") {
		...
		if ($title_background_type == "pattern") {
			...
			$title_background_class			= 'ts-icon-title-background';
		} else if (($title_background_type == "gradient") && ($title_background_gradient != '')) {
			$title_background_style			= $title_background_gradient;
			$title_background_class			= 'ts-icon-title-background';
		} else {
		...
		if (($animation_shadow != '') && (($title_background_type == "pattern") || (($title_background_type == "color") && ($title_background_color != '')) || (($title_background_type == "gradient") && ($title_background_gradient != '')))) {
		...
		$output .= '<div id="' . $icon_title_id . '" class="' . $css_class . ' ' . $animation_css . ' ' . $el_class . ' ' . $title_background_class . ' clearFixMe ' . $title_border_radius . '" style="height: auto; margin-top:' . $margin_top . 'px; margin-bottom:' . $margin_bottom . 'px; ' . $google_font . '">';
