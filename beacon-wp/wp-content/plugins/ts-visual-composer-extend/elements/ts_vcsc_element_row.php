<?php
	...
	if (function_exists('vc_add_param')) {
		...
		if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_ExtendedRowsModules["backgrounds"]["videoyoutube"] == "true") {
			$TS_VCSC_RowBackgroundSelection[__( "YouTube Video I", "ts_visual_composer_extend")]		= "youtubemb";
			$TS_VCSC_RowBackgroundSelection[__( "YouTube Video II", "ts_visual_composer_extend")]		= "youtube";
		...
		if ($TS_VCSC_RowBackgroundVideoYoutube) {
			$TS_VCSC_RowSettingsParamsArray = array (
				array(
					...
					"dependency" 				=> array("element" => "ts_row_bg_effects", "value" => array("youtube", "youtubemb")),
					"group" 					=> __( "VCE Background", "ts_visual_composer_extend"),
				),
				array(
					"type"						=> "attach_image",
