<?php
    ...
    $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
		...
		"icon" 	                    => "ts-composer-element-icon-icon-title",
		"class"                     => "",
		...
		"params"                    => array(
			...
			array(
				"type"              => "switch_button",
				"heading"           => __( "Use Page/Post Title", "ts_visual_composer_extend" ),
				"param_name"        => "title_auto",
				"value"             => "false",
				"admin_label"       => true,
				"description"       => __( "Switch the toggle if you want to use the official page or post title for this element.", "ts_visual_composer_extend" )
			),				
			array(
				"type"              => "switch_button",
				...
				"dependency"        => array( 'element' => "title_auto", 'value' => 'false' ),
			),
			array(
				"type"              => "textfield",
			...
			array(
				...
				"class"				=> "",
				"heading"			=> __("Title Gradient Background", "ts_visual_composer_extend"),						
				"param_name"		=> "title_background_gradient",
				"description"		=> __('Use the controls above to create a custom gradient background for the element.', 'ts_visual_composer_extend'),
				"dependency"        => array( 'element' => "title_background_type", 'value' => 'gradient' ),
				"group" 			=> "Title Design",
			),
			array(
				"type"              => "dropdown",
				...
				"dependency"        => array( 'element' => "title_background_type", 'value' => array('color', 'gradient') ),
				"group" 			=> "Title Design",
			),
			array(
				"type"              => "background",
			...
			array(
				...
				"heading" 				=> __("Title Border Settings", "ts_visual_composer_extend"),
