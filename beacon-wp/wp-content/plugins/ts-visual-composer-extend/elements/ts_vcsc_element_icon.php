	...
	$VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
		...
		"params"                    	=> array(
			...
			array(
				...
				"default"				=> "bottomright",
				"std"					=> "bottomright",
				"description"			=> __( "Define where on the screen the link should be placed; 'Default' equals position where this element has been placed in Visual Composer.", "ts_visual_composer_extend" ),
