    ...
    $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_VisualComposer_Element = array(
			...
			array(
				...
				array(
					...
					"param_name"            => "content_facebook_trigger",
                    "value"                 => array(
                ...
                array(
                    ...
                    "dependency"            => array( 'element' => "content_facebook_trigger", 'value' => array('preview', 'default', 'image') ),
					"group" 				=> "Trigger Settings",
                ),
				array(
					'type' 					=> $VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_IconSelectorType,
					'heading' 				=> __( 'Select Icon', 'ts_visual_composer_extend' ),
					'param_name' 			=> 'content_facebook_icon',
					'value'					=> '',
					...
					"dependency"            => array( 'element' => "content_facebook_trigger", 'value' => array('icon', 'flaticon') ),
					"group" 				=> "Trigger Settings",
				),	
				array(
					"type"                  => "nouislider",
					"heading"               => __( "Icon Size", "ts_visual_composer_extend" ),
					"param_name"            => "content_facebook_iconsize",
					"value"                 => "30",
					"min"                   => "16",
					"max"                   => "512",
					"step"                  => "1",
					...
					"dependency"            => array( 'element' => "content_facebook_trigger", 'value' => 'icon' ),
					"group" 				=> "Trigger Settings",
				),
				array(
					"type"                  => "colorpicker",
					"heading"               => __( "Icon Color", "ts_visual_composer_extend" ),
					"param_name"            => "content_facebook_iconcolor",
					"value"                 => "#cccccc",
                ...
                array(
                    ...
                    "param_name"            => "content_facebook_buttonstyle",
                    "width"                 => 300,
					...
					"dependency"            => array( 'element' => "content_facebook_trigger", 'value' => array('flat', 'flaticon') ),
					"group" 				=> "Trigger Settings",
                ),
                array(
                    "type"                  => "dropdown",
                    "heading"               => __( "Button Hover Style", "ts_visual_composer_extend" ),
                    "param_name"            => "content_facebook_buttonhover",
                    "width"                 => 300,
                ...
                array(
                    ...
                    "param_name"            => "content_facebook_buttontext",
                    "value"                 => "View Video",
                    "description"           => __( "Enter the text for the button.", "ts_visual_composer_extend" ),
                    "dependency"            => array( 'element' => "content_facebook_trigger", 'value' => array('winged', 'simple', 'flat', 'flaticon') ),
					"group" 				=> "Trigger Settings",
                ),
                array(
                    "type"                  => "nouislider",
                ...
                array(
                    ...
                    "param_name"            => "content_facebook_text",
                    "value"                 => "",
                    "description"           => __( "Enter the trigger text for the video.", "ts_visual_composer_extend" ),
                    "dependency"            => array( 'element' => "content_facebook_trigger", 'value' => 'text' ),
					"group" 				=> "Trigger Settings",
                ),
                // Custom Code
                array(
                    ...
                    "dependency"            => array( 'element' => "content_facebook_trigger", 'value' => 'custom' ),
					"group" 				=> "Trigger Settings",
                ),
                // Title + Subtitle
                array(
                    ...
                    "param_name"            => "content_facebook_title",
                    "value"                 => "",
                    "description"           => __( "Enter a title for the lightbox content.", "ts_visual_composer_extend" ),
                    "dependency"            => array( 'element' => "content_facebook_trigger", 'value' => array('image', 'default', 'preview', 'winged', 'flat', 'flaticon') ),
					"group" 				=> "Trigger Settings",
                ),
                array(
                    "type"                  => "textfield",
                    "heading"               => __( "Subtitle", "ts_visual_composer_extend" ),
                    "param_name"            => "content_facebook_subtitle",
                    "value"                 => "",
                    "description"           => __( "Enter a subtitle for the lightbox content.", "ts_visual_composer_extend" ),
                    "dependency"            => array( 'element' => "content_facebook_trigger", 'value' => array('winged') ),
					"group" 				=> "Trigger Settings",
                ),				
				// Overlay Settings
				array(
					...
					"dependency"        	=> array( 'element' => "content_facebook_trigger", 'value' => array('default', 'image', 'preview') ),				
					"group" 				=> "Trigger Settings",
				),			
				array(
					"type"              	=> "colorpicker",
