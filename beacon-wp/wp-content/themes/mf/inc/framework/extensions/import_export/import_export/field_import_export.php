    ...
    if ( ! class_exists( 'ReduxFramework_import_export' ) ) {
        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                ?>
                    <h4><?php esc_html_e( 'Import Options', 'mf' ); ?></h4>

                    <p>
                        <a href="javascript:void(0);" id="redux-import-code-button" class="button-secondary button-ic">
                            <?php esc_html_e( 'Import from File', 'mf' ); ?>
                        </a>
                        <a href="javascript:void(0);" id="redux-import-link-button" class="button-secondary button-ic">
                            <?php esc_html_e( 'Import from URL', 'mf' ) ?>
                        </a>
                    </p>

                    <div id="redux-import-code-wrapper">
                        <p class="description" id="import-code-description">
                            <?php echo esc_html( apply_filters( 'redux-import-file-description', esc_html__( 'Input your backup file below and hit Import to restore your sites options from a backup.', 'mf' ) ) ); ?>
                        </p>
                    ...
                    <div id="redux-import-link-wrapper">
                        <p class="description" id="import-link-description"><?php echo esc_html( apply_filters( 'redux-import-link-description', esc_html__( 'Input the URL to another sites options set and hit Import to load the options from that site.', 'mf' ) ) ); ?></p>
                        <?php // $this->parent->args['opt_name'] is sanitized in the ReduxFramework class, no need to re-sanitize it. ?>
                    ...
                    <p id="redux-import-action"><input type="submit" id="redux-import" name="import" class="button-primary" value="<?php esc_html_e( 'Import', 'mf' ) ?>">&nbsp;&nbsp;<span><?php echo esc_html( apply_filters( 'redux-import-warning', esc_html__( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'mf' ) ) ) ?></span></p>

                    <div class="hr"/>
                    <div class="inner"><span>&nbsp;</span></div></div>
                    <h4><?php esc_html_e( 'Export Options', 'mf' ) ?></h4>

                    <div class="redux-section-desc">
                        <p class="description">
                            <?php echo esc_html( apply_filters( 'redux-backup-description', esc_html__( 'Here you can copy/download your current option settings. Keep this safe as you can use it as a backup should anything go wrong, or you can use it to restore your settings on this site (or any other site).', 'mf' ) ) ) ?>
                        </p>
                    </div>
                <?php
                ...
                ?>
                    <p>
                        <a href="javascript:void(0);" id="redux-export-code-copy" class="button-secondary button-ic"><?php esc_html_e( 'Copy Data', 'mf' ) ?></a>
                        <a href="<?php  echo esc_url($link); ?>" id="redux-export-code-dl" class="button-primary button-ic"><?php esc_html_e( 'Download Data File', 'mf' ) ?></a>
                        <a href="javascript:void(0);" id="redux-export-link" class="button-secondary button-ic"><?php esc_html_e( 'Copy Export URL', 'mf' ) ?></a>
                    </p>
